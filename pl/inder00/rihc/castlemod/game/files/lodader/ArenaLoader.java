...
public class ArenaLoader
{
  ...
  public static void saveArenas()
  {
    for (Arena a : Arena.arenas) {
      ...
      yml.set("arena.castle.x1", Integer.valueOf(a.getX1()));
      yml.set("arena.castle.z1", Integer.valueOf(a.getZ1()));
      yml.set("arena.castle.x2", Integer.valueOf(a.getX2()));
      yml.set("arena.castle.z2", Integer.valueOf(a.getZ2()));
      yml.set("arena.castle.spawn.x1", Integer.valueOf(a.getSpawn_1_x()));
      yml.set("arena.castle.spawn.y1", Integer.valueOf(a.getSpawn_1_y()));
      yml.set("arena.castle.spawn.z1", Integer.valueOf(a.getSpawn_1_z()));
      yml.set("arena.castle.spawn.world1", a.getSpawn_1_world());
      yml.set("arena.castle.spawn.x2", Integer.valueOf(a.getSpawn_2_x()));
      yml.set("arena.castle.spawn.y2", Integer.valueOf(a.getSpawn_2_y()));
      yml.set("arena.castle.spawn.z2", Integer.valueOf(a.getSpawn_2_z()));
      yml.set("arena.castle.spawn.world2", a.getSpawn_2_world());
      yml.set("arena.map.x1", Integer.valueOf(a.getMap_1_x()));
      yml.set("arena.map.y1", Integer.valueOf(a.getMap_1_y()));
      yml.set("arena.map.z1", Integer.valueOf(a.getMap_1_z()));
      yml.set("arena.map.world1", a.getMap_1_world());
      yml.set("arena.map.x2", Integer.valueOf(a.getMap_2_x()));
      yml.set("arena.map.y2", Integer.valueOf(a.getMap_2_y()));
      yml.set("arena.map.z2", Integer.valueOf(a.getMap_2_z()));
      yml.set("arena.map.world2", a.getMap_2_world());
      
      yml.set("arena.attack.x1", Integer.valueOf(a.getAttack_1_x()));
      yml.set("arena.attack.y1", Integer.valueOf(a.getAttack_1_y()));
      yml.set("arena.attack.z1", Integer.valueOf(a.getAttack_1_z()));
      
      yml.set("arena.attack.x2", Integer.valueOf(a.getAttack_2_x()));
      yml.set("arena.attack.y2", Integer.valueOf(a.getAttack_2_y()));
      yml.set("arena.attack.z2", Integer.valueOf(a.getAttack_2_z()));
      try {
        yml.save(f);
      } catch (IOException e) {
        e.printStackTrace();
